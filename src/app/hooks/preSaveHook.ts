...
export function PreSaveHook_withAttachSlug( schema: Schema, fieldForSlug: string, extraTextForSlug?: string ) {

  schema.pre("save", async function (next) { // 🔍 এই হুক শুধুমাত্র `.save()` বা `.create()` করার আগে চলে
