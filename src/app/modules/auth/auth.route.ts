...
import { registerSchema } from "../user/user.zodSchema";


export const  authRouter : Router = Router();

authRouter.post("/register",ValidationRequestHandler_HigherFunc(registerSchema), authControllers.registerUser);
