...
export const excludeFieldForDeleteFromQuery = ["searchTerm", "sort", "fields", "field", "page", "limit" ];// egulo url e ja dibe, query hisebe seguloi ekane array te newa, varibale name o same dewa hoise, but egulo variable mean kora hoccena, egulo user filter korar somoy url e query hisebe jegulo takbe sei same name e takte hobe jmn :
